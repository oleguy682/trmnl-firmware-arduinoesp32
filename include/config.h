...
#define PIN_INTERRUPT 0         //the boot button (directly on ESP32-S3 module, active LOW)
#define FAKE_BATTERY_VOLTAGE    //USB powered for now; remove when battery ADC is configured
#endif
